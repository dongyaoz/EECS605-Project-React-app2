...
const DROPDOWN_API_ENDPOINT = 'https://8a1g4elsic.execute-api.us-east-2.amazonaws.com/prod/'; // TODO
const ML_API_ENDPOINT = 'https://p0tgg9r4fk.execute-api.us-east-2.amazonaws.com/prod/'; // TODO
  ...
  const handleSubmit = (event) => {
    ...
    .then(data => {
      ...
      // POST request success
        ...
        setOutputFileData2(decodeFile2Base64(outputBytesData2));
      }
